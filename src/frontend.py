...
class StoreGUI:
    ...
    def build_customer_ui(self):
        ...
        ttk.Button(filter_search_frame, text="جستجو", command=self.apply_search_and_filter).pack(side=tk.LEFT, padx=(0, 5))
        ...
        ttk.Button(add_to_cart_frame, text="افزودن به سبد خرید", command=self.add_to_cart).grid(row=2, column=0, columnspan=2, pady=10)
    ...
    def add_to_cart(self):
        ...
        self.load_products_into_treeview(category_filter=self.category_filter_combobox.get(), search_query=self.search_entry.get().strip().lower()) 
    ...
    def build_admin_ui(self):
        ...
        self.admin_tree = ttk.Treeview(product_management_frame, columns=("ID", "Name", "Price", "Stock", "Category"), show="headings")
        ...
        ttk.Button(add_product_frame, text="افزودن/به‌روزرسانی محصول", command=self.add_or_update_product).grid(row=5, column=0, columnspan=2, pady=15)
    ...
    def build_order_management_tab(self, parent_frame):
        ...
        self.orders_tree = ttk.Treeview(parent_frame, columns=("OrderID", "Username", "TotalPrice", "OrderDate"), show="headings")
        ...
        self.order_items_tree = ttk.Treeview(parent_frame, columns=("ProductID", "ProductName", "Quantity", "PriceAtOrder"), show="headings")
